...
const Button = forwardRef(function Button(
  ...
  const styles = {
    primary: 'bg-espresso text-cream px-7 py-4 hover:bg-clayDark rounded-none',
    outline: 'border border-espresso/60 text-espresso px-7 py-4 hover:border-espresso hover:bg-espresso hover:text-cream rounded-none',
    ghost: 'text-espresso px-0 py-0 underline-grow',
  }
